...
public class h_border {
    public static void main(String[] args) {
        ...
        panel_EtchedBorder.add(new JLabel("Etched Border"));
        ...
        panel_RaisedBevelBorder.add(new JLabel("Raised Bevel Border"));
        ...
        panel_LoweredBevelBorder.add(new JLabel("Lowered Bevel Border"));
        ...
        panel_TitledBorder.add(new JLabel("Titled Bevel Border"));
        ...
        panel_TitledBorder_Right.add(new JLabel("Right Titled Bevel Border"));
        ...
        panel_CompoundBorder.add(new JLabel("Compound Border"));
        ...
        panel_MatteBorder.add(new JLabel("Matte Border"));
